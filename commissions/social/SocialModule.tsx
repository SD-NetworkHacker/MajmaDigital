      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-3">
          <button 
             ...
             className="flex items-center gap-3 bg-rose-600 text-white px-8 py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-2xl hover:bg-rose-700 transition-all active:scale-95 group"
          >
            <HandHelping size={18} />
            Solliciter une Aide
          </button>
