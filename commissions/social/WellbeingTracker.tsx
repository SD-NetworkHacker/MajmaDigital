...
const WellbeingTracker: React.FC = () => {
  const cohesionTrend = [
    { name: 'Jan', val: 72 }, { name: 'Fév', val: 75 },
    { name: 'Mar', val: 68 }, { name: 'Avr', val: 84 },
    { name: 'Mai', val: 88 },
  ];

  const alerts = [
    { name: 'Abdou Wade', issue: 'Absent (3 sorties)', status: 'Urgent', color: 'text-rose-600' },
    { name: 'Sokhna Fall', issue: 'Nouvelle (Peu active)', status: 'Suivi', color: 'text-amber-600' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 glass-card p-10 bg-white">
           <div className="flex justify-between items-center mb-12">
              ...
              <div className="p-3 bg-emerald-50 text-emerald-600 rounded-xl font-black text-xs">+12.4%</div>
           </div>
           ...
           <div className="grid grid-cols-3 gap-6 pt-10 border-t border-slate-50">
              {[
                { l: 'Moyenne Sorties', v: '4.2/an' },
                { l: 'Taux Parrainage', v: '92%' },
                { l: 'Satisfaction', v: '98%' }
              ].map((s, i) => (
           ...
           <div className="glass-card p-10 bg-slate-900 text-white relative overflow-hidden group">
              <div className="relative z-10">
                 ...
                 <div className="flex items-center gap-4 text-emerald-400 mb-6">
                    <Sparkles size={24} />
                    <p className="text-sm font-medium italic opacity-80 leading-relaxed">"Proposez à Abdou Wade d'aider la commission Organisation pour le prochain tournoi. Son profil indique une passion pour le sport."</p>
                 </div>
              </div>
