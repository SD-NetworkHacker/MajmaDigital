-- Supabase Update Script for Majma' Platform
-- This script contains the full schema for the platform.
...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS coordinates JSONB DEFAULT '{"lat": 0, "lng": 0}';
...
-- RLS Policies (Basic example, adjust as needed)
