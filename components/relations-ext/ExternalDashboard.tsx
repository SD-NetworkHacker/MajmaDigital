...
import { 
  ...
  Map, HeartHandshake, MessageSquare, ChevronRight,
...
const ExternalDashboard: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'partnerships', label: 'Conventions', icon: HeartHandshake },
      ...
      {activeTab === 'overview' && (
        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             ...
             <div className="glass-card p-6 bg-white border border-slate-100 flex flex-col justify-between">
                <div className="flex justify-between items-start">
                   <div className="p-3 bg-emerald-50 text-emerald-600 rounded-2xl"><HeartHandshake size={20}/></div>
