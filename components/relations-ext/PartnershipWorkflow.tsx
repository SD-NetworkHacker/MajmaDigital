...
import { HeartHandshake, Target, Clock, CheckCircle, AlertTriangle, Plus, ChevronRight, FileText, Landmark, Award } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6">
        <div>
          ...
          <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest mt-2 flex items-center gap-2">
            <HeartHandshake size={14} className="text-slate-600" /> Administration des accords juridiques et protocolaires
          </p>
        </div>
