                ...
                <div className="grid grid-cols-2 gap-6">
                   <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                         ...
                         {availableFleet.length === 0 && <p className="text-[9px] text-rose-500 italic">Aucun véhicule disponible</p>}
                      </div>
                      <div className="space-y-2">
                   ...
                   <div className="space-y-4">
                      ...
                      {availableDrivers.length === 0 && <p className="text-[9px] text-rose-500 italic">Aucun chauffeur disponible</p>}
